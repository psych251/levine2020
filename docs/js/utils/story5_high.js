...
var story = story_begin + '<i> "I would love to use those new traps to catch more' +
    ' rabbits faster, but what would happen if everyone did that? If everyone' +
    ' used the new traps, all the rabbits would disappear from the forest. I' +
    ' don&#39;t want that to happen, so I&#39;m not going to use the new traps."' +
    ' </i> </p>' + story_end; 
