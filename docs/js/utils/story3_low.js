...
var story = story_begin + '<i> "I&#39;m just not interested in using that new tube.' +
    ' I really only need to catch a few clams a day, and I like to do that at a' +
    ' leisurely pace and spend all day clamming. I&#39;m not in any rush and I' +
    ' don&#39;t need to catch more clams. Besides, if everyone used the new tube,' +
    ' all the clams would disappear from the bay. I don&#39;t want that to happen.' +
    ' But even if there were so many clams in the bay that everyone could use the' +
    ' new tube, I wouldn&#39;t want to use them anyway."</i> </p>' + story_end;
