...
var story = story_begin + '<i> "I would love to use that new gun to hunt more ' +
    'pheasants faster, but what would happen if everyone did that? If everyone ' +
    'used the new gun, all the pheasants would disappear from the forest. I ' +
    'don&#39;t want that to happen, so I&#39;m not going to use the new gun."' +
    '</i> </p>' + story_end; 
