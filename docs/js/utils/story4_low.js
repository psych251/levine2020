...
var story = story_begin + '<i> "I&#39;m just not interested in using that new' +
    ' knife. I really only need to gather a few mushrooms a day, and I like to' +
    ' do that at a leisurely pace and spend all day foraging. I&#39;m not in any' +
    ' rush and I don&#39;t need to gather more mushrooms. Besides, if everyone' +
    ' used the new knife, all the mushrooms would disappear from the forest. I' +
    ' don&#39;t want that to happen. But even if there were so many mushrooms in' +
    ' the forest that everyone could use the new knife, I wouldn&#39;t want to' +
    ' use it anyway." </i> </p>' + story_end;
